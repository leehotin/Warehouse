...
router.get('/',async function(req, res, next) {
    try{
        ...
        //呼叫物件裡的方法
        //let data = await iOemuSys.Read(inquire,db,collection);
        //console.log(data);
        // console.log(stock);
        ...
        //for(x in data){
            ...
            let data = await iOemuSys.joinCollection(
                'Warehouse-In_Out_system',   //   dbName|
    ...
    try{
        ...
        let data = await iOemuSys.sort(inquire,['Warehouse-In_Out_system','products',req.query.seq]);
        ...
        res.render('productlist/index',{datas:data,sort:inquire});
    }
    finally{
        //關閉連線
        await iOemuSys.disconnect();
    ...
    try{
        ...
        //await iOemuSys.delete('Warehouse-In_Out_system','products',['Product_id',req.body.call_no]);
        /*res.writeHead(200,{
